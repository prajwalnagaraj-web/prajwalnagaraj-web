...
Driven by **curiosity** and a passion for **building**. I enjoy exploring **new technologies**, creating projects, solving problems, and continuously learning across different areas of **software and engineering**. This space is a collection of things I learn, build, optimize, and occasionally break while experimenting with new tools, frameworks, and ideas.

## Quick Overview :star2:
:mortar_board: Masters in Management and Leadership Certificate, Data Analytics, and a Bachelor’s in Electronics and Instrumentation Engineering. 🎓
...
![](https://img.shields.io/badge/Microsoft_Excel-217346?logo=microsoft-excel&logoColor=white)](https://github.com/prajwalnagaraj-web)!(https://img.shields.io/badge/Confluence-172B4D?logo=confluence&logoColor=white)
